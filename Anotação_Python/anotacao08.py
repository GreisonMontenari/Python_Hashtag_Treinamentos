""" Elif
Exemplo: Vamos criar um programa para analisar o bônus dos funcinários de uma empresa (pode parecer "simples", mas uma empresa como a Amazon tem 900.000 funcionários)
...
Se ela vendeu acima da meta dela, ela ganha um bônus 3% do valor que ela vendeu.
